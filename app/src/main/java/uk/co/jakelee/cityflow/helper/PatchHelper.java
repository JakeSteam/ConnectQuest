...
public class PatchHelper extends AsyncTask<String, String, String> {
    ...
    private void createPuzzlesPack2() {
        ...
        tiles.add(new Tile(31, 19, 0, 0, Constants.ROTATION_NORTH));
        tiles.add(new Tile(31, 25, 0, 1, Constants.ROTATION_NORTH));
        tiles.add(new Tile(31, 20, 0, 2, Constants.ROTATION_NORTH));
        tiles.add(new Tile(31, 48, 0, 3, Constants.ROTATION_NORTH));
        tiles.add(new Tile(31, 38, 1, 0, Constants.ROTATION_NORTH));
        tiles.add(new Tile(31, 22, 1, 1, Constants.ROTATION_NORTH));
        tiles.add(new Tile(31, 13, 1, 2, Constants.ROTATION_NORTH));
        tiles.add(new Tile(31, 47, 1, 3, Constants.ROTATION_NORTH));
        tiles.add(new Tile(31, 38, 2, 0, Constants.ROTATION_NORTH));
        tiles.add(new Tile(31, 22, 2, 1, Constants.ROTATION_NORTH));
        tiles.add(new Tile(31, 30, 2, 2, Constants.ROTATION_NORTH));
        tiles.add(new Tile(31, 20, 2, 3, Constants.ROTATION_NORTH));
        tiles.add(new Tile(31, 19, 3, 0, Constants.ROTATION_NORTH));
        tiles.add(new Tile(31, 25, 3, 1, Constants.ROTATION_NORTH));
        tiles.add(new Tile(31, 29, 3, 2, Constants.ROTATION_NORTH));
        tiles.add(new Tile(31, 19, 3, 3, Constants.ROTATION_NORTH));
