...
public class PatchHelper extends AsyncTask<String, String, String> {
    ...
    private void createText() {
        ...
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_2_HINT", ""));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_3_NAME", "Sunrise"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_3_HINT", "Unlocked by completing achievement \"Turn It Up 1\"."));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_4_NAME", "Grass"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_4_HINT", "Unlocked by completing achievement \"Turn It Up 2\"."));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_5_NAME", "Salmon"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_5_HINT", "Unlocked by completing achievement \"Turn It Up 3\"."));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_6_NAME", "Bluish"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_6_HINT", "Unlocked by completing achievement \"Turn It Up 4\"."));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_7_NAME", "Pink"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_7_HINT", "Unlocked by completing achievement \"The Best Quest 1\"."));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_8_NAME", "Bark"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_8_HINT", "Unlocked by completing achievement \"The Best Quest 2\"."));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_9_NAME", "Earth"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_9_HINT", "Unlocked by completing achievement \"The Best Quest 3\"."));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_10_NAME", "Stormy Sky"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_10_HINT", "Unlocked by completing achievement \"The Best Quest 4\"."));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_11_NAME", "Deep Sea"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_11_HINT", "Unlocked by completing achievement \"Working Your Way Through 1\"."));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_12_NAME", "Limestone"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_12_HINT", "Unlocked by completing achievement \"Working Your Way Through 2\"."));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_13_NAME", "Sand"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_13_HINT", "Unlocked by completing achievement \"Working Your Way Through 3\"."));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_14_NAME", "Fern"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_14_HINT", "Unlocked by completing achievement \"Working Your Way Through 4\"."));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_15_NAME", "Olive"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_15_HINT", "Unlocked by completing achievement \"Completionist 1\"."));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_16_NAME", "Fawn"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_16_HINT", "Unlocked by completing achievement \"Completionist 2\"."));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_17_NAME", "Sedona"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_17_HINT", "Unlocked by completing achievement \"Completionist 3\"."));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_18_NAME", "Eggshell"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_18_HINT", "Unlocked by completing achievement \"Completionist 4\"."));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_19_NAME", "Clay"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_19_HINT", ""));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_20_NAME", "Clay Grey"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_20_HINT", ""));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_21_NAME", "Muddy"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_21_HINT", ""));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_22_NAME", "Muddy Pink"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_22_HINT", ""));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_23_NAME", "Limey"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_23_HINT", "Unlocked by completing achievement \"Activate Boost 1\"."));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_24_NAME", "Rich Limey"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_24_HINT", "Unlocked by completing achievement \"Activate Boost 2\"."));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_25_NAME", "Camouflage"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_25_HINT", "Unlocked by completing achievement \"Activate Boost 3\"."));
        ...
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_31_HINT", ""));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_32_NAME", "Passionfruit"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_32_HINT", ""));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_33_NAME", "The End"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_33_HINT", ""));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_34_NAME", "Desert"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_34_HINT", ""));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_35_NAME", "Dirty"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_35_HINT", ""));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_36_NAME", "Overcast"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_36_HINT", ""));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_37_NAME", "Pretty In Pink"));
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "BACKGROUND_37_HINT", ""));
    ...
    private void createPuzzlesPack1() {
        ...
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "PUZZLE_1_NAME", "Make The Loop"));
        ...
        tiles.add(new Tile(1, 1, 0, 1, 4));
        tiles.add(new Tile(1, 1, 1, 1, 4));
        tiles.add(new Tile(1, 1, 1, 0, 4));
        tiles.add(new Tile(1, 1, 0, 0, 4));


        texts.add(new Text(Constants.LANGUAGE_EN_GB, "PUZZLE_2_NAME", "Multiple Flows"));
        ...
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "PUZZLE_3_NAME", "Divide And Rejoin"));
        ...
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "PUZZLE_4_NAME", "Convert And Cross"));
        ...
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "PUZZLE_5_NAME", "Shop Alcove"));
        ...
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "PUZZLE_6_NAME", "The Path To Roads"));
        ...
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "PUZZLE_7_NAME", "Riverside Stones"));
        ...
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "PUZZLE_8_NAME", "Crossover Chaos"));
        ...
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "PUZZLE_9_NAME", "Forest Adventure"));
        ...
        texts.add(new Text(Constants.LANGUAGE_EN_GB, "PUZZLE_10_NAME", "A Scenic City"));
