...
public class DatabaseHelper {
    ...
    private static void createTileType() {
        List<Tile_Type> tileTypes = new ArrayList<>();
            ...
            tileTypes.add(new Tile_Type(41, Constants.ENVIRONMENT_CITY, Constants.FLOW_NONE, Constants.FLOW_NONE, Constants.FLOW_CANAL, Constants.FLOW_NONE, Constants.HEIGHT_NORMAL, 3));
